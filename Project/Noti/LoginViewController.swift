...
class LoginViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let text = "저희 소프트웨어전공 자치회에서 중간고사에 지친 학우여러분들을위해 야식 배부 사업을 진행하고자 합니다! 이번 야식은 큐카페의 '아메리카노(ice / hot) + 머핀 세트'를 준비했습니다! 목,금 1-6시에 로비에서 쿠폰을 배부할 예정이니 야식을 드실 분들은 정해진 시간에 학생증을 가지고 와주세요! 쿠폰 사용방법 1. 정해진 시간[이번주 목,금 오후 1-6시]에 학생증을 가지고 로비에서 쿠폰을 배부받는다. 2. 10/24(월) - 10/28(금) 사이에 원하는 시간에 큐카페에서 쿠폰을 내고 야식을 받는다. 3. 아메리카노는 ice, hot을 선택할 수 있으며, 머핀도 초코, 블루베리, 치즈 세가지 맛중 한개를 선택할 수 있습니다. 4. 쿠폰에 적혀있는 선택지는 본인이 체크할 필요없습니다!! (큐카페에서 체크해주신다고 합니다!)"
        ...
        /*
        Reductio.summarize(text: text, count: 1) { phrases in
            print(phrases)
        }*/
    }
